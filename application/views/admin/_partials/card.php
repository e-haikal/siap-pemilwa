...
<script type="text/javascript">
    ...
    function updateJumlahPemilih() {
        $.ajax({
            url: '<?= base_url('admin/utama/get_jumlah_pemilih'); ?>', // Sesuaikan dengan controller dan method yang sesuai
            type: 'GET',
            dataType: 'json',
            success: function(response) {
    ...
    function updateJumlahKandidat() {
        $.ajax({
            url: '<?= base_url('admin/utama/get_jumlah_kandidat'); ?>', // Sesuaikan dengan controller dan method yang sesuai
            type: 'GET',
            dataType: 'json',
            success: function(response) {
    ...
    function updateJumlahPetugas() {
        $.ajax({
            url: '<?= base_url('admin/utama/get_jumlah_petugas'); ?>', // Sesuaikan dengan controller dan method yang sesuai
            type: 'GET',
            dataType: 'json',
            success: function(response) {
